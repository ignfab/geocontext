...
const intersectsPointFilterSchema = z.object({
  lon: lonSchema.describe("Longitude du point en WGS84."),
  lat: latSchema.describe("Latitude du point en WGS84."),
...
const isolinePointSchema = z.object({
  lon: lonSchema.describe("Longitude du point de départ en WGS84."),
  lat: latSchema.describe("Latitude du point de départ en WGS84."),
}).strict();
...
export const gpfItineraryLayerInputObjectSchema = z.object({
  departure_lon: lonSchema.describe("Longitude du point de départ en WGS84."),
  departure_lat: latSchema.describe("Latitude du point de départ en WGS84."),
  arrival_lon: lonSchema.describe("Longitude du point d'arrivée en WGS84."),
  arrival_lat: latSchema.describe("Latitude du point d'arrivée en WGS84."),
